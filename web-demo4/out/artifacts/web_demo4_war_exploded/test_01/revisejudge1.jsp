...
<%
    ...
    if(name == ""){
        ...
        out.print("<script language='javaScript'> alert('该户主信息不存在');window.history.back(-1);</script>");
    }else{
%>
<table border="1"style="text-align:center;">
    ...
    <tr>
        ...
        <td align="center"><a style="color:blue" href='revisejudge2.jsp?name=<%=rs.getObject(5) %>' onclick="javascript:return rev()">修改</a> </td>
    </tr>
    <%
                }
            }
